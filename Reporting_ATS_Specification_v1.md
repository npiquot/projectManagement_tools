...
**Version :** 0.9 (en cours de spécification)
...
- Au moment de l'import, l'utilisateur **saisit la période** via **deux listes déroulantes** :
  ...
  - **Année** : **2026 à 2030**.
- La période (mois + année) ainsi saisie **identifie l'extraction**. À l'import, les filtres (§4) sont appliqués, puis les données sont rattachées à cette période.
...
Seuls les projets satisfaisant **toutes** les conditions suivantes sont pris en compte. **Tous les filtres sont insensibles à la casse.**

1. `Intitulé projet` **contient** « AEO » **OU** « PIAT ».
2. `Suivi dans Pulse` **=** « Oui ».

> **Règle générale (transverse) :** sauf spécification explicite contraire, ces filtres de base s'appliquent à **tous les écrans** de l'outil.
